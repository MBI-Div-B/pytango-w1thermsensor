#!/usr/bin/python3 -u
import tango
from tango import Database, DevFailed, AttrWriteType, DevState, DeviceProxy, DispLevel, READ, Attr
...
class TemperatureProbe(Device):
    ...
    def initialize_dynamic_attributes(self):
        ...
        for j, probe_id in enumerate(self.probe_ids):
            attr_dict = dict(name='Probe_{nr}'.format(nr=probe_id), dtype=tango.DevFloat, access=READ)
